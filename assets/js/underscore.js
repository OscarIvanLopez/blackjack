! function(n, r) {
    ...
    function xr(n, r, t) {
        var e = [];
        return r = qn(r, t), mr(n, (function(n, t, u) {
            r(n, t, u) && e.push(n)
        })), e
    }
    function Sr(n, r, t) {
    ...
    var Yr = Xr({
        ...
        template: function(n, r, t) {
            ...
            n.replace(u, (function(r, t, e, u, a) {
                return i += n.slice(o, a).replace(Qn, Xn), o = a + r.length, t ? i += "'+\n((__t=(" + t + "))==null?'':_.escape(__t))+\n'" : e ? i += "'+\n((__t=(" + e + "))==null?'':__t)+\n'" : u && (i += "';\n" + u + "\n__p+='"), r
        ...
        sortBy: function(n, r, t) {
            var e = 0;
            return r = qn(r, t), Br(jr(n, (function(n, t, u) {
                return {
                    value: n,
                    index: e++,
                    criteria: r(n, t, u)
        ...
        initial: Wr,
        last: function(n, r, t) {
            return null == n || n.length < 1 ? null == r || t ? void 0 : [] : null == r || t ? n[n.length - 1] : Lr(n, Math.max(0, n.length - r))
        },
        rest: Lr,
        tail: Lr,
        drop: Lr,
